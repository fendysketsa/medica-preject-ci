    ...
    <div class="login-right-wrap">
        ...
        <div class="form-group input-group">
            ...
            <div class="input-group">
                ...
                <input type="email" id="email" autocomplete="off" form="form-login" class="form-control form-control-sm" placeholder="Email" required autofocus>
            </div>
        </div>
        ...
        <div class="form-group input-group">
            ...
            <div class="pass-group input-group">
                ...
                <input type="password" id="password" autocomplete="off" form="form-login" class="form-control form-control-sm pass-input" placeholder="Password" required>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-6 text-right">
                    <a class="forgot-link" href="forgot-password.php">Lupa Password ?</a>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $(".forgoted").on('click', function() {

            if ($("#forgot").attr('attention') == 'false') {
                $("#forgot").removeClass('sr-only').attr('attention', 'true').show();
                setTimeout(function() {
                    $("#forgot").addClass('sr-only').attr('attention', 'false').hide();
                }, 3000)
        ...
        $("#form-login").submit(function(e) {
            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    snd.play();
                    toastr.error('Kesalahan system!', 'Eror', {
                        timeOut: 2000,
                        fadeOut: 2000,
                        onHidden: function() {
                            localStorage.removeItem('sound-welcome')
